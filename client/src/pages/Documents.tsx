            ...
            <div className="relative hidden lg:block pt-8 w-3/4 ml-auto">
              <div className="rounded-2xl border border-white/25 bg-white/10 backdrop-blur-xl shadow-2xl p-3">
                <div className="flex items-center gap-1.5 mb-3">
                  ...
                  <span className="ml-1.5 text-white/65 text-[10px]">DAQS Library · Live</span>
                </div>
              ...
              <div className="absolute top-12 -right-3 bg-white/15 backdrop-blur-xl border border-white/30 rounded-lg shadow-lg p-2 w-40 hidden xl:block z-10">
                ...
                <div className="text-white text-[11px] font-semibold leading-tight">Verified Downloads</div>
                <div className="text-white/70 text-[10px] leading-tight mt-0.5">Every document reviewed by our team</div>
              </div>
              ...
              <div className="absolute bottom-4 -left-3 bg-white/15 backdrop-blur-xl border border-white/30 rounded-lg shadow-lg p-2 w-40 hidden xl:block z-10">
                ...
                <div className="text-white text-[11px] font-semibold leading-tight">Whitepapers & Case Studies</div>
                <div className="text-white/70 text-[10px] leading-tight mt-0.5">Updated as new research lands</div>
              </div>
            </div>
          </div>
        </div>
