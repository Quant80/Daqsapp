            ...
            <div className="relative hidden lg:block pt-8 w-3/4 ml-auto">
              <div className="rounded-2xl border border-white/25 bg-white/10 backdrop-blur-xl shadow-2xl p-3">
                <div className="flex items-center gap-1.5 mb-3">
                  ...
                  <span className="ml-1.5 text-white/65 text-[10px]">DAQS Academy · Live</span>
                </div>
              ...
              <div className="absolute top-12 -right-3 bg-white/15 backdrop-blur-xl border border-white/30 rounded-lg shadow-lg p-2 w-40 hidden xl:block z-10">
                ...
                <div className="text-white text-[11px] font-semibold leading-tight">Enrolment Open</div>
                <div className="text-white/70 text-[10px] leading-tight mt-0.5">Online & in-person seats available</div>
              </div>
              ...
              <div className="absolute bottom-4 -left-3 bg-white/15 backdrop-blur-xl border border-white/30 rounded-lg shadow-lg p-2 w-40 hidden xl:block z-10">
                ...
                <div className="text-white text-[11px] font-semibold leading-tight">Industry-Recognised</div>
                <div className="text-white/70 text-[10px] leading-tight mt-0.5">Certificate of completion included</div>
              </div>
            </div>
          </div>
        </div>
